...
export default {
  ...
  data() {
    ...
    const manager_codes = store.getters["base/manager_code"]
    ...
    const rows = [
      {
        name: "دبیرستان باقرالعلوم",
        paye: "دوره ی دوم ",
        Kind: "پسرانه",
        address: "سوهانک برج مروارید ",
        token: "asdasdadas",
      },
    ];
      ...
      if (
        ...
        axios
          .post(address.add_school(), {
            ...
            manager_code:this.manager_codes ,
          })
          .then((x) => {
            console.log(x.data)
            if (x.data.OK === true) {
